...
class $CategoriesTableTable extends CategoriesTable
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, name, icon, type, parentId, systemKey, createdAt, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Transaction extends DataClass implements Insertable<Transaction> {
  ...
  int get hashCode => Object.hash(id, type, accountId, categoryId, amount,
      currencyCode, description, date, note, transferId, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class $TransfersTableTable extends TransfersTable
    with TableInfo<$TransfersTableTable, Transfer> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<String> toAccountId = GeneratedColumn<String>(
      ...
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _sourceAmountMeta =
      const VerificationMeta('sourceAmount');
  @override
  late final GeneratedColumn<int> sourceAmount = GeneratedColumn<int>(
      'source_amount', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _destinationAmountMeta =
      const VerificationMeta('destinationAmount');
  @override
  late final GeneratedColumn<int> destinationAmount = GeneratedColumn<int>(
      'destination_amount', aliasedName, false,
      type: DriftSqlType.int, requiredDuringInsert: true);
  static const VerificationMeta _currencyCodeMeta =
      const VerificationMeta('currencyCode');
  @override
    ...
    if (data.containsKey('destination_amount')) {
      context.handle(
          ...
          destinationAmount.isAcceptableOrUnknown(
              data['destination_amount']!, _destinationAmountMeta));
    } else if (isInserting) {
      context.missing(_destinationAmountMeta);
    }
    if (data.containsKey('currency_code')) {
      context.handle(
          _currencyCodeMeta,
  ...
  Transfer map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Transfer(
      ...
      sourceAmount: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}source_amount'])!,
      destinationAmount: attachedDatabase.typeMapping.read(
          DriftSqlType.int, data['${effectivePrefix}destination_amount'])!,
      currencyCode: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}currency_code'])!,
...
class Transfer extends DataClass implements Insertable<Transfer> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['source_amount'] = Variable<int>(sourceAmount);
    map['destination_amount'] = Variable<int>(destinationAmount);
    map['currency_code'] = Variable<String>(currencyCode);
  ...
  factory Transfer.fromJson(Map<String, dynamic> json,
    ...
    return Transfer(
      ...
      sourceAmount: serializer.fromJson<int>(json['sourceAmount']),
      destinationAmount: serializer.fromJson<int>(json['destinationAmount']),
      currencyCode: serializer.fromJson<String>(json['currencyCode']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'sourceAmount': serializer.toJson<int>(sourceAmount),
      'destinationAmount': serializer.toJson<int>(destinationAmount),
      'currencyCode': serializer.toJson<String>(currencyCode),
  ...
  Transfer copyWithCompanion(TransfersTableCompanion data) {
    return Transfer(
      id: data.id.present ? data.id.value : this.id,
...
class TransfersTableCompanion extends UpdateCompanion<Transfer> {
  final Value<String> id;
  final Value<String> fromAccountId;
  final Value<String> toAccountId;
  final Value<int> sourceAmount;
  final Value<int> destinationAmount;
  final Value<String> currencyCode;
  ...
  TransfersTableCompanion.insert({
    ...
    required int sourceAmount,
    required int destinationAmount,
    required String currencyCode,
    this.exchangeRate = const Value.absent(),
    this.description = const Value.absent(),
    required DateTime date,
  ...
  static Insertable<Transfer> custom({
    ...
    Expression<int>? sourceAmount,
    Expression<int>? destinationAmount,
    Expression<String>? currencyCode,
  ...
  TransfersTableCompanion copyWith(
      ...
      Value<int>? sourceAmount,
      Value<int>? destinationAmount,
      Value<String>? currencyCode,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (sourceAmount.present) {
      map['source_amount'] = Variable<int>(sourceAmount.value);
    }
    if (destinationAmount.present) {
      map['destination_amount'] = Variable<int>(destinationAmount.value);
    }
    if (currencyCode.present) {
      map['currency_code'] = Variable<String>(currencyCode.value);
    }
...
class $RecurringTransactionsTableTable extends RecurringTransactionsTable
  ...
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
      type: DriftSqlType.string, requiredDuringInsert: true);
  static const VerificationMeta _transactionTemplateIdMeta =
      const VerificationMeta('transactionTemplateId');
  @override
  late final GeneratedColumn<String> transactionTemplateId =
      GeneratedColumn<String>('transaction_template_id', aliasedName, false,
          type: DriftSqlType.string, requiredDuringInsert: true);
  ...
  late final GeneratedColumn<bool> autoCreate = GeneratedColumn<bool>(
      ...
      requiredDuringInsert: false,
      defaultConstraints:
          GeneratedColumn.constraintIsAlways('CHECK ("auto_create" IN (0, 1))'),
  ...
  VerificationContext validateIntegrity(
    ...
    if (data.containsKey('transaction_template_id')) {
      context.handle(
          _transactionTemplateIdMeta,
          transactionTemplateId.isAcceptableOrUnknown(
              data['transaction_template_id']!, _transactionTemplateIdMeta));
    } else if (isInserting) {
      context.missing(_transactionTemplateIdMeta);
    }
  ...
  RecurringTransaction map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return RecurringTransaction(
      id: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}id'])!,
      transactionTemplateId: attachedDatabase.typeMapping.read(
          DriftSqlType.string,
          data['${effectivePrefix}transaction_template_id'])!,
      ...
      autoCreate: attachedDatabase.typeMapping
          .read(DriftSqlType.bool, data['${effectivePrefix}auto_create'])!,
...
class RecurringTransaction extends DataClass
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    final map = <String, Expression>{};
    map['id'] = Variable<String>(id);
    map['transaction_template_id'] = Variable<String>(transactionTemplateId);
  ...
  RecurringTransactionsTableCompanion toCompanion(bool nullToAbsent) {
    return RecurringTransactionsTableCompanion(
      id: Value(id),
      transactionTemplateId: Value(transactionTemplateId),
  ...
  factory RecurringTransaction.fromJson(Map<String, dynamic> json,
    ...
    return RecurringTransaction(
      id: serializer.fromJson<String>(json['id']),
      transactionTemplateId:
          serializer.fromJson<String>(json['transactionTemplateId']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      'id': serializer.toJson<String>(id),
      'transactionTemplateId': serializer.toJson<String>(transactionTemplateId),
  ...
  RecurringTransaction copyWithCompanion(
    ...
    return RecurringTransaction(
      id: data.id.present ? data.id.value : this.id,
      transactionTemplateId: data.transactionTemplateId.present
          ? data.transactionTemplateId.value
          : this.transactionTemplateId,
  ...
  String toString() {
    return (StringBuffer('RecurringTransaction(')
          ..write('id: $id, ')
          ..write('transactionTemplateId: $transactionTemplateId, ')
  ...
  bool operator ==(Object other) =>
      ...
      (other is RecurringTransaction &&
          other.id == this.id &&
          other.transactionTemplateId == this.transactionTemplateId &&
...
class RecurringTransactionsTableCompanion
  ...
  final Value<String> id;
  final Value<String> transactionTemplateId;
  ...
  const RecurringTransactionsTableCompanion({
    this.id = const Value.absent(),
    this.transactionTemplateId = const Value.absent(),
  ...
  RecurringTransactionsTableCompanion.insert({
    required String id,
    required String transactionTemplateId,
  ...
  static Insertable<RecurringTransaction> custom({
    Expression<String>? id,
    Expression<String>? transactionTemplateId,
  ...
  RecurringTransactionsTableCompanion copyWith(
      {Value<String>? id,
      Value<String>? transactionTemplateId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (transactionTemplateId.present) {
      map['transaction_template_id'] =
          Variable<String>(transactionTemplateId.value);
    }
...
class Budget extends DataClass implements Insertable<Budget> {
  ...
  @override
  int get hashCode => Object.hash(id, categoryId, amount, currencyCode, period,
...
class $DebtsTableTable extends DebtsTable
    with TableInfo<$DebtsTableTable, Debt> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<int> paidInstallments = GeneratedColumn<int>(
      'paid_installments', aliasedName, true,
      type: DriftSqlType.int, requiredDuringInsert: false);
  ...
  Debt map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return Debt(
      ...
      originalAmount: attachedDatabase.typeMapping
          .read(DriftSqlType.int, data['${effectivePrefix}original_amount'])!,
...
class Debt extends DataClass implements Insertable<Debt> {
  ...
  Debt copyWithCompanion(DebtsTableCompanion data) {
    return Debt(
      id: data.id.present ? data.id.value : this.id,
      personName:
...
class DebtsTableCompanion extends UpdateCompanion<Debt> {
  final Value<String> id;
...
class $DebtPaymentsTableTable extends DebtPaymentsTable
    with TableInfo<$DebtPaymentsTableTable, DebtPayment> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, debtId, accountId, amount, date, note, createdAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class DebtPayment extends DataClass implements Insertable<DebtPayment> {
  ...
  DebtPayment copyWithCompanion(DebtPaymentsTableCompanion data) {
    return DebtPayment(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  int get hashCode =>
      Object.hash(id, debtId, accountId, amount, date, note, createdAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class DebtPaymentsTableCompanion extends UpdateCompanion<DebtPayment> {
  final Value<String> id;
...
class $CurrenciesTableTable extends CurrenciesTable
    with TableInfo<$CurrenciesTableTable, Currency> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  late final GeneratedColumn<int> decimalDigits = GeneratedColumn<int>(
      ...
      defaultValue: const Constant(0));
  @override
  List<GeneratedColumn> get $columns => [code, name, symbol, decimalDigits];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
...
class Currency extends DataClass implements Insertable<Currency> {
  ...
  Currency copyWith(
          {String? code, String? name, String? symbol, int? decimalDigits}) =>
      Currency(
        code: code ?? this.code,
        name: name ?? this.name,
  ...
  Currency copyWithCompanion(CurrenciesTableCompanion data) {
    return Currency(
...
class CurrenciesTableCompanion extends UpdateCompanion<Currency> {
...
class $ExchangeRatesTableTable extends ExchangeRatesTable
    with TableInfo<$ExchangeRatesTableTable, ExchangeRate> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  ...
  @override
  Set<GeneratedColumn> get $primaryKey => {baseCurrency, targetCurrency, date};
  @override
...
class ExchangeRate extends DataClass implements Insertable<ExchangeRate> {
  ...
  ExchangeRate copyWithCompanion(ExchangeRatesTableCompanion data) {
    return ExchangeRate(
  ...
  @override
  int get hashCode => Object.hash(baseCurrency, targetCurrency, rate, date);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
...
class ExchangeRatesTableCompanion extends UpdateCompanion<ExchangeRate> {
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index idxRecurringNextOccurrence = Index(
      'idx_recurring_next_occurrence',
      'CREATE INDEX idx_recurring_next_occurrence ON recurring_transactions (next_occurrence)');
  late final Index idxDebtsDueDate = Index('idx_debts_due_date',
      'CREATE INDEX idx_debts_due_date ON debts (due_date)');
  late final Index idxDebtPaymentsDebtId = Index('idx_debt_payments_debt_id',
...
class $$AccountsTableTableTableManager extends RootTableManager<
    ...
    (Account, BaseReferences<_$AppDatabase, $AccountsTableTable, Account>),
    Account,
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    ...
                    BaseReferences<_$AppDatabase, $AccountsTableTable, Account>(
                        db, table, e)
                  ))
              .toList(),
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    ...
                    BaseReferences<_$AppDatabase, $CategoriesTableTable,
                        Category>(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
...
typedef $$TransactionsTableTableProcessedTableManager = ProcessedTableManager<
    ...
    Transaction,
    PrefetchHooks Function()>;
typedef $$TransfersTableTableCreateCompanionBuilder = TransfersTableCompanion
    Function({
  required String id,
  required String fromAccountId,
  required String toAccountId,
...
typedef $$TransfersTableTableUpdateCompanionBuilder = TransfersTableCompanion
    Function({
  Value<String> id,
  Value<String> fromAccountId,
  Value<String> toAccountId,
...
class $$TransfersTableTableFilterComposer
  ...
  ColumnFilters<int> get sourceAmount => $composableBuilder(
      column: $table.sourceAmount, builder: (column) => ColumnFilters(column));

  ColumnFilters<int> get destinationAmount => $composableBuilder(
...
class $$TransfersTableTableOrderingComposer
  ...
  ColumnOrderings<int> get sourceAmount => $composableBuilder(
      column: $table.sourceAmount,
      builder: (column) => ColumnOrderings(column));

  ColumnOrderings<int> get destinationAmount => $composableBuilder(
      column: $table.destinationAmount,
      builder: (column) => ColumnOrderings(column));
...
class $$TransfersTableTableAnnotationComposer
  ...
  GeneratedColumn<int> get sourceAmount => $composableBuilder(
      column: $table.sourceAmount, builder: (column) => column);

  GeneratedColumn<int> get destinationAmount => $composableBuilder(
      column: $table.destinationAmount, builder: (column) => column);
...
class $$TransfersTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    $TransfersTableTable,
    Transfer,
    $$TransfersTableTableFilterComposer,
    ...
    (Transfer, BaseReferences<_$AppDatabase, $TransfersTableTable, Transfer>),
    Transfer,
    PrefetchHooks Function()> {
  $$TransfersTableTableTableManager(
      _$AppDatabase db, $TransfersTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          updateCompanionCallback: ({
            ...
            Value<int> sourceAmount = const Value.absent(),
            Value<int> destinationAmount = const Value.absent(),
            Value<String> currencyCode = const Value.absent(),
            Value<double?> exchangeRate = const Value.absent(),
            Value<String?> description = const Value.absent(),
            Value<DateTime> date = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$TransfersTableTable, Transfer>(table),
                    BaseReferences<_$AppDatabase, $TransfersTableTable,
                        Transfer>(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
...
typedef $$TransfersTableTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $TransfersTableTable,
    Transfer,
    $$TransfersTableTableFilterComposer,
...
class $$RecurringTransactionsTableTableFilterComposer
  ...
  ColumnFilters<String> get transactionTemplateId => $composableBuilder(
      column: $table.transactionTemplateId,
      builder: (column) => ColumnFilters(column));
...
class $$RecurringTransactionsTableTableOrderingComposer
  ...
  ColumnOrderings<String> get transactionTemplateId => $composableBuilder(
      column: $table.transactionTemplateId,
      builder: (column) => ColumnOrderings(column));
...
class $$RecurringTransactionsTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get transactionTemplateId => $composableBuilder(
      column: $table.transactionTemplateId, builder: (column) => column);
...
class $$RecurringTransactionsTableTableTableManager extends RootTableManager<
  ...
  $$RecurringTransactionsTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
            Value<String> transactionTemplateId = const Value.absent(),
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$RecurringTransactionsTableTable,
...
class $$BudgetsTableTableTableManager extends RootTableManager<
    ...
    (Budget, BaseReferences<_$AppDatabase, $BudgetsTableTable, Budget>),
    Budget,
    PrefetchHooks Function()> {
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    ...
                    BaseReferences<_$AppDatabase, $BudgetsTableTable, Budget>(
                        db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    ...
                    BaseReferences<_$AppDatabase, $GoalsTableTable, Goal>(
                        db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
...
class $$DebtsTableTableTableManager extends RootTableManager<
    ...
    (Debt, BaseReferences<_$AppDatabase, $DebtsTableTable, Debt>),
    Debt,
    PrefetchHooks Function()> {
  $$DebtsTableTableTableManager(_$AppDatabase db, $DebtsTableTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$DebtsTableTable, Debt>(table),
                    BaseReferences<_$AppDatabase, $DebtsTableTable, Debt>(
                        db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
...
class $$DebtPaymentsTableTableTableManager extends RootTableManager<
    _$AppDatabase,
    ...
    (
      DebtPayment,
      BaseReferences<_$AppDatabase, $DebtPaymentsTableTable, DebtPayment>
    ),
    DebtPayment,
    PrefetchHooks Function()> {
  $$DebtPaymentsTableTableTableManager(
      _$AppDatabase db, $DebtPaymentsTableTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$DebtPaymentsTableTable, DebtPayment>(table),
                    BaseReferences<_$AppDatabase, $DebtPaymentsTableTable,
                        DebtPayment>(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
        ));
...
typedef $$DebtPaymentsTableTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $DebtPaymentsTableTable,
    DebtPayment,
    $$DebtPaymentsTableTableFilterComposer,
...
class $$CurrenciesTableTableTableManager extends RootTableManager<
    ...
    (Currency, BaseReferences<_$AppDatabase, $CurrenciesTableTable, Currency>),
    Currency,
    PrefetchHooks Function()> {
  $$CurrenciesTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$CurrenciesTableTable, Currency>(table),
                    BaseReferences<_$AppDatabase, $CurrenciesTableTable,
                        Currency>(db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
...
typedef $$CurrenciesTableTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $CurrenciesTableTable,
    Currency,
    $$CurrenciesTableTableFilterComposer,
...
class $$ExchangeRatesTableTableTableManager extends RootTableManager<
    ...
    (
      ExchangeRate,
      BaseReferences<_$AppDatabase, $ExchangeRatesTableTable, ExchangeRate>
    ),
    ExchangeRate,
    PrefetchHooks Function()> {
  $$ExchangeRatesTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$ExchangeRatesTableTable, ExchangeRate>(table),
...
class $$NotesTableTableTableManager extends RootTableManager<
    ...
    (Note, BaseReferences<_$AppDatabase, $NotesTableTable, Note>),
    Note,
    PrefetchHooks Function()> {
  $$NotesTableTableTableManager(_$AppDatabase db, $NotesTableTable table)
      : super(TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              .map((e) => (
                    e.readTable<$NotesTableTable, Note>(table),
                    BaseReferences<_$AppDatabase, $NotesTableTable, Note>(
                        db, table, e)
                  ))
              .toList(),
          prefetchHooksCallback: null,
